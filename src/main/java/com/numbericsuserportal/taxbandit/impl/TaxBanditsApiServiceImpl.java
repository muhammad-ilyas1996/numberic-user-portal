...
public class TaxBanditsApiServiceImpl implements TaxBanditsApiService {
    ...
    public CreateForm1099NECResponseDTO createForm1099NEC(CreateForm1099NECRequestDTO request) {
        try {
            ...
            // Official SDK format: https://testapi.taxbandits.com/V1.7.3/
            ...
            System.out.println("Authorization Header: Bearer " + (accessToken != null ? accessToken.substring(0, Math.min(50, accessToken.length())) + "..." : "NULL"));
