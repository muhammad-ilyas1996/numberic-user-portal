...
public class AnthropicChatService {
    ...
    private ChatResponseDto chatViaManagedAgents(User user, String userMessage, OnboardingResponseDto profile,
        ...
        try {
            ...
            String payload = buildUserPayloadWithProfile(userMessage, profile, includeProfileInPrompt);
    ...
    private String buildUserPayloadWithProfile(String userMessage, OnboardingResponseDto ob, boolean includeProfile) {
    ...
    private ChatResponseDto chatViaMessagesApi(User user, OnboardingResponseDto profile, String userMessage,
            boolean includeProfileInPrompt) {
        String system = buildMessagesApiSystemPrompt(profile, includeProfileInPrompt);
    ...
    private String buildMessagesApiSystemPrompt(OnboardingResponseDto ob, boolean includeProfile) {
